...
const Page = ({ subId, setSubId }) => {
  ...
  const initalData = data[`/announcement/social/networks/list/?page=${page + 1}&page_size=${rowsPerPage}&search=${searchValue}`];
...
useEffect(()=> {
  ...
  function getCountries() {
      fetchData(`/announcement/social/networks/list/?page=${page + 1}&page_size=${rowsPerPage}&search=${searchValue}`);
  }
